...
Sage Club is where traders, developers, and researchers come together to design,
backtest, and deploy algorithmic trading strategies. We share open-source tools,
research notes, and battle-tested code so members can move from idea to live
strategy faster.
...
1. **Browse our repositories** — start with the ones pinned above.
2. **Read the contributing guide** in any repo before opening a PR.
3. **Join the discussion** — links in each repo's README.
4. **Ship something** — even a small indicator or notebook is a great first contribution.

## For New Members

If you're new to algorithmic trading, we recommend starting here:

- `sage-starter-kit` — opinionated boilerplate for your first strategy
- `sage-backtest-101` — a guided introduction to backtesting
- `sage-research-notes` — beginner-friendly write-ups of core concepts
...
> Everything published under Sage Club is for **educational and research purposes only**.
> Nothing in this organization constitutes financial advice. Trading involves
> substantial risk of loss. Past performance — backtested or live — is not
> indicative of future results. Always do your own research and trade only with
